...
MentionListComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MentionListComponent, selectors: [["mention-list"]], viewQuery: function MentionListComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.NgForOf, ɵngcc1.NgTemplateOutlet], styles: [".mention-menu[_ngcontent-%COMP%]{background-clip:padding-box;background-color:#fff;border:1px solid rgba(0,0,0,.15);border-radius:.25em;color:#212529;display:none;float:left;font-size:1em;left:0;list-style:none;margin:.125em 0 0;min-width:11em;padding:.5em 0;position:absolute;text-align:left;top:100%;z-index:1000}.mention-item[_ngcontent-%COMP%]{background-color:transparent;border:0;clear:both;color:#212529;display:block;font-weight:400;line-height:1.5em;padding:.2em 1.5em;text-align:inherit;white-space:nowrap}.mention-active[_ngcontent-%COMP%] > a[_ngcontent-%COMP%]{background-color:#337ab7;color:#fff;outline:0;text-decoration:none}.scrollable-menu[_ngcontent-%COMP%]{display:block;height:auto;max-height:292px;overflow:auto}[hidden][_ngcontent-%COMP%]{display:none}.mention-dropdown[_ngcontent-%COMP%]{bottom:100%;margin-bottom:2px;top:auto}"] });
...
MentionModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule
        ]] });
