(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-mentions'] = {}, global.ng.core, global.ng.common));
    ...
    MentionListComponent.propDecorators = {
        ...
        defaultItemTemplate: [{ type: core.ViewChild, args: ['defaultItemTemplate', { static: true },] }]
    };
    ...
    var MentionDirective = /** @class */ (function () {
        function MentionDirective(_element, _componentResolver, _viewContainerRef) {
            ...
            this.DEFAULT_CONFIG = {
                ...
                allowSpace: false,
                returnTrigger: false,
                mentionSelect: function (item, triggerChar) {
                    return _this.activeConfig.triggerChar + item[_this.activeConfig.labelKey];
                },
                mentionFilter: function (searchString, items) {
                    var searchStringLowerCase = searchString.toLowerCase();
                    return items.filter(function (e) { return e[_this.activeConfig.labelKey].toLowerCase().startsWith(searchStringLowerCase); });
                }
            };
    ...
    MentionDirective.propDecorators = {
        mention: [{ type: core.Input, args: ['mention',] }],
        mentionConfig: [{ type: core.Input }],
        mentionListTemplate: [{ type: core.Input }],
        searchTerm: [{ type: core.Output }],
